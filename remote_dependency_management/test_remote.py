...
def test_new_image_triggers_pull_and_restart():
	...
	if current_container_version != "0.1.0" and current_container_version != ecr_image_version:
		pytest.fail(f"Container version {current_container_version} and/or ECR image version {ecr_image_version} wrong")
