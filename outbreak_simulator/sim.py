...
class Case:
    ...
    def __init__(self, pathogen, request={}):
        self.pathogen = pathogen
        self.case_status = request.get("case_status", random.choice(CASE_STATUSES))
        self.pathogen_status = request.get("pathogen_status", random.choice(PATHOGEN_STATUSES))
        ...
        self.previous_infection = request.get("previous_infection", random.choice(Y_N_NA))
        ...
        self.vaccination_date = request.get("vaccination_date", FAKE.date(pattern="%m-%d-%Y"))
        ...
        self.date_confirmation = request.get("date_confirmation", FAKE.date(pattern="%m-%d-%Y"))
        ...
        self.reason_for_hospitalization = request.get("reason_for_hospitalization", random.choice(REASONS_FOR_HOSPITALIZATION))
        self.date_hospitalization = request.get("date_hospitalization", FAKE.date(pattern="%m-%d-%Y"))
        self.date_discharge_hospital = request.get("date_discharge_hospital", FAKE.date(pattern="%m-%d-%Y"))
        self.intensive_care = request.get("intensive_care", random.choice(Y_N_NA))
        self.date_admission_icu = request.get("date_admission_icu", FAKE.date(pattern="%m-%d-%Y"))
        self.date_discharge_icu = request.get("date_discharge_icu", FAKE.date(pattern="%m-%d-%Y"))
        ...
        self.date_recovered = request.get("date_recovered", FAKE.date(pattern="%m-%d-%Y"))

        self.contact_with_case = request.get("contact_with_case", random.choice(Y_N_NA))
        self.contact_id = request.get("contact_id")
        self.contact_setting = request.get("contact_setting", random.choice(CONTACT_SETTINGS))
        self.contact_setting_other = request.get("contact_setting_other")
        self.contact_animal = request.get("contact_animal", random.choice(CONTACT_ANIMALS))
        ...
        self.date_last_modified = request.get("date_last_modified", FAKE.date(pattern="%m-%d-%Y"))
